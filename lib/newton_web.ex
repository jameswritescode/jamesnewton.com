defmodule NewtonWeb do
  ...
  def static_paths,
    do:
      ~w(assets fonts images favicon.ico favicon.svg favicon-32.png favicon-96.png apple-touch-icon.png og-default.png og-links.png robots.txt)
  ...
  def controller do
    quote do
      ...
      use Gettext, backend: NewtonWeb.Gettext
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: NewtonWeb.Router,
        statics: NewtonWeb.static_paths()
    end
  end
